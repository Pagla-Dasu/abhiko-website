...
export const NavbarLogo = () => {
	return (
		...
		>
			<Image src="/abhiko-logo.png" alt="logo" width={30} height={30} />
...
export const NavbarButton = ({
	href,
	as: Tag = "button", // Changed default to button
	children,
	className,
	variant = "primary",
	...props
	...
	const variantStyles = {
		...
		secondary: "bg-transparent shadow-none dark:text-white text-slate-800",
